describe("Login with Create study",function()
{
    ...
    {                                                    
     ...
     it('Enter Survey Attributes ',function(){ 
        ...
        cy.wait(2000)
        cy.get(':nth-child(1) > [_ngcontent-c7=""] > app-input > .demo-full-width > .cstm_input_field')
        .type('CUstom1')
        cy.get('#type2').click()
        cy.get(':nth-child(3) > [_ngcontent-c7=""] > app-input > .demo-full-width > .cstm_input_field')
        ...
        cy.get('.overview_price_row > :nth-child(1)').contains('Price')
